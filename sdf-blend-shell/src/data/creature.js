...
// watching those overlaps stay seamless while colors blend and
// the arm moves.
// ============================================================

export const CREATURE = [
  { id: 'torso', type: 'capsule', a: [-0.55, 0.0, 0.0], b: [0.55, 0.0, 0.0], r: 0.5, color: 0x4fd1a5 },
  { id: 'head', type: 'sphere', a: [-0.95, 0.6, 0.0], r: 0.35, color: 0xf2b05a },
  { id: 'arm', type: 'capsule', a: [0.45, 0.25, 0.0], b: [1.25, 0.9, 0.15], r: 0.22, color: 0x6f8cff },
];
